...
Anti-bot jeet tax protection enabled
...
contract DaddyInu is Context, IERC20, Ownable {
	...
	string private constant _name = "Daddy Inu";

	string private constant _symbol = "DADDYINU";
	...
	function _transfer(address from, address to, uint256 amount) private {
		...
		if (from != owner() && to != owner()) {
			...
			if(_canTrade && to==_pair && _antiBotEnabled){

				thisTax=_jeetPunishmentTax;
