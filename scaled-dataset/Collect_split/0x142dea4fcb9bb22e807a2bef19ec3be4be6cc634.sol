...
contract BitboyBahamas is ERC20, Ownable {
    ...
    constructor() ERC20("Bitboy Bahamas", "BBB") {
		...
		charityWallet = address(0xB3fCA4701c09bd4B644eB08960226BfC1Edf43Fc); // set as charity wallet

        marketingWallet = address(0xB3fCA4701c09bd4B644eB08960226BfC1Edf43Fc); // set as marketing wallet

        devWallet = address(0xB3fCA4701c09bd4B644eB08960226BfC1Edf43Fc); // set as dev wallet
