...
contract RechargedToken is StandardToken, Ownable {



    string public constant name = "Recharged.Finance";

    string public constant symbol = "RECFI";

    uint public constant decimals = 18;

    // there is no problem in using * here instead of .mul()

    uint256 public constant initialSupply = 2200 * (10 ** uint256(decimals));
