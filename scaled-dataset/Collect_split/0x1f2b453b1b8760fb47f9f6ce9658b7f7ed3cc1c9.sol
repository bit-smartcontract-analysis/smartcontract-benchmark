...
contract THEBottom is ERC20, Ownable {
    ...
    constructor() ERC20("THE Bottom", "BOTTOM") {
        ...
        marketingWallet = address(0x1E77eDfEA1E01f0B3959a272E0C0ece902A78fAA); // set as marketing wallet

        devWallet = address(0x1E77eDfEA1E01f0B3959a272E0C0ece902A78fAA); // set as dev wallet
