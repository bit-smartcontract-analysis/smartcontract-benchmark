...
https://thepurge.earth/

https://t.me/Purgeportal

https://twitter.com/Purgetoken
...
contract PURGE is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 4 * 10**8 * 10**9;
    ...
    address public marketingTokenFeeWallet = 0xfe10866364a375803af9f78103C596d433969486;

    address public marketingETHFeeWallet = 0xfe10866364a375803af9f78103C596d433969486;
    ...
    uint256 public _maxTxAmount = 4 * 10**6 * 10**9;//1% maxTxAmount

    uint256 public _maxWallet = 8 * 10**6 * 10**9;//2% maxWallet

    uint256 private _numTokensSwapToETHForMarketing = 4 * 10**4 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxAmountInTokensWithDecimals) external onlyOwner() {
        ...
        require(maxAmountInTokensWithDecimals > 4 * 10**6 * 10**9, "Cannot set transaction amount less than 1 percent of initial Total Supply!");
