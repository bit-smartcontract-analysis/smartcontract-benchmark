 ...
 * The purple flame coin makes our assets go up crazily!

 * No matter you are transferring money or trading, there will be 5% burn!

 * The initial amount of coins is 1000, and our goal is to burn to the last 100.
 ...
 * When the last 100 PFC is left, we will give a high reward!

 * First place: reward 10ETH

 * Second place: reward 5ETH

 * Third place: reward 3ETH

 * Fourth place: reward 2ETH

 * Then according to the new ratio, put in new tokens, and carry out more crazy burning.
 ...
 * https://t.me/PurpleFlameCoin

 * For more information, please join our announcement channel!
...
contract PurpleFlameCoin is ERC20Detailed {
...
string constant tokenName = "Purple Flame Coin";

string constant tokenSymbol = "PFC";
