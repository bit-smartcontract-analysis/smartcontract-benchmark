...
contract UNOSstaking is Ownable {
    ...
    uint private constant stakingAndDaoTokens = 10000e18;   // 10000 UNOS (18 Decimals) are staked by UNOS Owner   

                                                            // Stakers will be Rewarded by these 10,000 Tokens
    ...
    // function to allow Creator to claim *other than UNOS* ERC20 Tokens, sent to this contract (by mistake) like USDT

    // UNOS can't be withdrawal because it will be staked for period of time with criteria
