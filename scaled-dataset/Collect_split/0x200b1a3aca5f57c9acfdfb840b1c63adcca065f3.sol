...
// These tokens grant access to the Gnostic Contract Marketplace, for more info about our tokenomics see Gnostic.network
...
contract Gnostic is ERC20 {
  ...
  string public constant name  = "Gnostic";
  ...
  uint256 burnRate = 1; // 1% Liquidity Pool Burn For Intitial Offering (See Lite-Paper at Gnostic.network) 

  uint256 _totalSupply = 100000000 * (10 ** 18); // 100 million supply of GNOS
