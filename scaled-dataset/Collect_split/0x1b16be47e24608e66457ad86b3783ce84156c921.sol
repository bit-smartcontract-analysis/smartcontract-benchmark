...
contract ShibaInuKiller is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x6a09C9f6C8aBb78364d0F7B168861a0203dac0eA);////////////////////

    address payable private _marketingAddress = payable(0x6a09C9f6C8aBb78364d0F7B168861a0203dac0eA);/////////////////////
