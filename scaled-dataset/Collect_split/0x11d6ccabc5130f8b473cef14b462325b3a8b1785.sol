...
contract AidNonTradable is Ownable, MinterRole, CanTransferRole {
    ...
    string public name = "AID - Non Tradable";
    ...
    // Returns the total claimed aid

    // This is just purely used to display the total aid claimed by users on the frontend
    ...
    // Set aid claimed to a custom value, for if we wanna reset the counter on new season release
