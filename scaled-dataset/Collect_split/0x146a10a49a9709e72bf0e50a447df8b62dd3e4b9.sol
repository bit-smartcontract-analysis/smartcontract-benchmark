...
contract Ghostface is IERC20, Ownable {
    ...
    string constant _name = "Ghostface";
    ...
    uint256 totalFee = 40;      // liquidityFee + developmentFee + reflectionFee + marketingFee
    ...
    uint256 swapThreshold = _totalSupply.mul(639749274).div(100000000000); // ~0.6%
