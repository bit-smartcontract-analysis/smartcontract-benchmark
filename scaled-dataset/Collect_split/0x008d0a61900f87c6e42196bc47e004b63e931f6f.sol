...
Our users are offered new layers of sophistication with each passing day. 

You can identify POD from the lots without blinking an eye with these firm pillars



Those who participate in the governance process receive periodic rewards in our native token of $POD.All in the spirit of cooperation.



https://t.me/pod_erc20
...
contract POD is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pillars of DeFi";
    ...
    address payable private _developmentAddress = payable(0x356BDc0791FD338013eEDD2e7a8b9F26B1D2B96C);

    address payable private _marketingAddress = payable(0x356BDc0791FD338013eEDD2e7a8b9F26B1D2B96C);
