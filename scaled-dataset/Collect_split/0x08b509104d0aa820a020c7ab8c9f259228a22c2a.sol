...
contract PotatoPunks is ERC721AQueryable, Ownable, ReentrancyGuard {

    using Strings for uint256;



    uint256 public maxSupply = 7557;
  ...
  constructor(string memory baseURI) ERC721A("Potato Punks", "PTTPNK") {
