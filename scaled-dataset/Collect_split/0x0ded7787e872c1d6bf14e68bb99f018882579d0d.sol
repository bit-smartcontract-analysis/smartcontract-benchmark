...
contract Candyland is ERC20, Ownable {
    ...
    constructor() ERC20("Candyland", "Candy") {
        ...
        maxWallet = 10_001 * 1e18; // 1% from total supply maxWallet
        ...
        marketingWallet = payable(0x33f16b7e59976F122F3170C008fC702487E32081); // set as marketing wallet

        devWallet = payable(0x33f16b7e59976F122F3170C008fC702487E32081); // set as dev wallet
