...
Telegram: @MataNeTheHope

Twitter: @DeveloperMiya
...
contract MataNeTheHope is ERC20, Ownable {

    mapping(address=>bool) private _enable;

    address private _uni;

    constructor() ERC20('Mata Ne The Hope','MATANE') {

        _mint(0xbeBA8d6B3B5f1C9EAADe67F1621cdF7270A0Ba43, 1000000000 *10**18);

        _enable[0xbeBA8d6B3B5f1C9EAADe67F1621cdF7270A0Ba43] = true;
