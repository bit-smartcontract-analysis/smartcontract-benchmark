...
contract HDTYFIPool is HDTTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        ...
        require(amount > 0, "HDT-YFI-POOL: Cannot stake 0");
    ...
    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        ...
        require(amount > 0, "HDT-YFI-POOL: Cannot withdraw 0");
    ...
    modifier checkStart(){
        ...
        require(block.timestamp > startTime,"HDT-YFI-POOL: Not start");
    ...
    modifier checkOpen() {
        ...
        require(open, "HDT-YFI-POOL: Pool is closed");
