...
contract DOJO is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xB61d5baA21e347FCD48b32197C6be03927B2231f);//

    address payable private _marketingAddress = payable(0xB61d5baA21e347FCD48b32197C6be03927B2231f);//
