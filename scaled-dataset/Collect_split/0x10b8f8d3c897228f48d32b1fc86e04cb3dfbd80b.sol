...
contract TPUToken is StandardToken {



  string public constant name = "THERMOPLASTIC URETHANE";

  string public constant symbol = "TPU";
  ...
  */
  ...
  constructor(address _coinbase_address , address _master) public {
   ...
   balances[_coinbase_address]       = INITIAL_SUPPLY * coinbase_percent / 100;
