 ...
 * PPGF will use the way of crowdfunding to distribute, the address of participating in the crowdfunding :0x419c343EF36E9770cbB8C4679f95cCdeFB8AfceA

 * The number of PPGF tokens allocated by the crowdfunding is 500,000,000. The minimum value of the crowdfunding is 3ETH and the maximum is 100ETH. For the end time, please follow the official website.
 ...
 * 2. With a coefficient of 25%, PPGF will hold ranking rewards. The current reward is the top 10. For every additional 100 addresses, 10 bonus positions will be added, and the reward will be ERLF tokens.

 * 3. 65% of the tax will be used to replace mainstream cryptocurrencies, and the proceeds will be used to protect the value of ERLF tokens.
