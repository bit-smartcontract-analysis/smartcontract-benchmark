...
contract VICTORIA is BurnableToken {



    string public constant name = "VICTORIA";
    ...
    uint256 public constant initialSupply = 4700000000 * (10 ** uint256(decimals));
