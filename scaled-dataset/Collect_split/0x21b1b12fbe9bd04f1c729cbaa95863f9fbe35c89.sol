...
// YOFI token by YOYO FINANCE Limited.
...
contract YOYOFI is StandardToken, OnlyOwner{

	uint256 public constant decimals = 18;

    string public constant name = "YOYO FINANCE";

    string public constant symbol = "YOFI";

    string public constant version = "1.0";

    uint256 public constant totalSupply =13000*10**18;
