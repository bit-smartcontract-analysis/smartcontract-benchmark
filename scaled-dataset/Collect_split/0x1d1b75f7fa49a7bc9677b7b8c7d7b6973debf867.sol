...
contract HDTTokenWrapper {
    ...
    IERC20 public stakeToken = IERC20(0x9f8F72aA9304c8B593d555F12eF6589cC3A579A2); 
...
contract HDTMKRPool is HDTTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        ...
        require(amount > 0, "HDT-MKR-POOL: Cannot stake 0");
    ...
    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        ...
        require(amount > 0, "HDT-MKR-POOL: Cannot withdraw 0");
    ...
    modifier checkStart(){
        ...
        require(block.timestamp > startTime,"HDT-MKR-POOL: Not start");
    ...
    modifier checkOpen() {
        ...
        require(open, "HDT-MKR-POOL: Pool is closed");
