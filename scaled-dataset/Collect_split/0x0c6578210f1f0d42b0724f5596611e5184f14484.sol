//https://t.me/PresidentsRemoval

//www.presidentsremoval.org
...
contract premoval is Context, IERC20, Ownable {
    ...
    string private _name = "President'sRemoval";

    string private _symbol = "XiHu";
    ...
    address payable public marketingWalletAddress = payable(0xf96f29FAAB1B32fab4A78C772A2f7d47e5aBA3Ac); 

    address payable public BurnedWalletAddress = payable(0xf96f29FAAB1B32fab4A78C772A2f7d47e5aBA3Ac); 
